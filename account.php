...
<section class="">
		...
		?>
			...
			<section class="caption">
				<h2 class="caption" style="text-align: center">Find Vehciles for renting</h2>
				<h3 class="properties" style="text-align: center">Cars and Bikes</h3>
			</section>
