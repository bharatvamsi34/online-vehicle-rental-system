			...
			<form method="post">
				...
				<?php
					if(isset($_POST['send'])){
						...
						$qry = "INSERT INTO smsg (null,client_id,$message,time,status)
...
<div id="footer">
	<div class="shell">
		<span class="left">&copy; <?php echo date("Y");?> - GBVH</span>
		<span class="right">
			Design by <a href="http://projectworlds.in">GBVH</a>
		</span>
	</div>
</div>
<!-- End Footer -->
